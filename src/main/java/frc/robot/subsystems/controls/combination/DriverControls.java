...
public class DriverControls {
    public static class DriverControlsSettings {
        ...
        /**
         * Creates a DriverControlsSettings and sets the varibles to equal the matching
         * property value.
         *
        ...
        public static DriverControlsSettings getDriverControlsSettings(Properties properties) {
            ...
            settings.shooterCurrentLaunchRPM = Double
                    .parseDouble(properties.getProperty("driverControls.shooterDefaultLaunchRPM"));
            settings.shooterOutpostLaunchRPM = Double
                    .parseDouble(properties.getProperty("driverControls.shooterOutpostLaunchRPM"));
            settings.shooterTrenchLaunchRPM = Double
                    .parseDouble(properties.getProperty("driverControls.shooterTrenchLaunchRPM"));
            settings.shooterAgainstHubLaunchRPM = Double
                    .parseDouble(properties.getProperty("driverControls.shooterAgainstHubLaunchRPM"));
            settings.shooterDepotLaunchRPM = Double
                    .parseDouble(properties.getProperty("driverControls.shooterDepotLaunchRPM"));
            settings.shooterPassRPM = Double.parseDouble(properties.getProperty("driverControls.shooterPassRPM"));
            ...
            settings.intakeReverseRPM = Double.parseDouble(properties.getProperty("driverControls.intakeReverseRPM"));
            settings.conveyorReverseRPM = Double
                    .parseDouble(properties.getProperty("driverControls.conveyorReverseRPM"));
            settings.intakeArmVolts = Double.parseDouble(properties.getProperty("driverControls.intakeArmVolts"));
            settings.indexerOutpostLaunchRPM = Double
                    .parseDouble(properties.getProperty("driverControls.indexerOutpostLaunchRPM"));
  ...
  public static void setupMainController(
    ...
    Command launchSequentialParallelSmartDashBoard =
        new SequentialCommandGroup(
            ...
            new ParallelCommandGroup(
                new FlywheelToVelocity(indexer, () -> {
                    if(SmartDashboard.getNumber(
                        "Controls/launchShooterRPM", settings.shooterCurrentLaunchRPM) == settings.shooterOutpostLaunchRPM) 
                        {return settings.indexerOutpostLaunchRPM;}
                    return settings.indexerLaunchRPM;}),
                new FlywheelToVelocity(conveyor, () -> {
                    if(SmartDashboard.getNumber(
                        "Controls/launchShooterRPM", settings.shooterCurrentLaunchRPM) == settings.shooterOutpostLaunchRPM) 
    ...
    Command DeployerVoltageMinus = new MotorRunVoltageCommand((Motor) intakeArm, () -> -settings.intakeArmVolts);
    Command DeployerVoltagePlus = new MotorRunVoltageCommand((Motor) intakeArm, () -> settings.intakeArmVolts);
    ...
    public static void setupAssistController(
        ...
        Command intakeOut = new ParallelCommandGroup(
                new FlywheelToVelocity(intake, () -> settings.intakeReverseRPM),
                new FlywheelToVelocity(conveyor, () -> settings.conveyorReverseRPM));
